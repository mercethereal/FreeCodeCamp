...
return Object.keys(collection).every(function(a){
    return (collection[a].hasOwnProperty(pre)&&Boolean(collection[a][pre]));
});
}

var x=truthCheck([{"name": "Pete", "onBoat": true}, {"name": "Repeat", "onBoat": true, "alias": "Repete"}, {"name": "FastFoward", "onBoat": true}], "onBoat") 
console.log(x);